    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.textWrapper}>
        <p className={styles.description}>
          Данный проект является частью исследования под названием «Расширение возможностей коммуникации с помощью
          удобного многоязычного словаря жестового языка», поддерживаемого Московским политехническим университетом в
